...
class CreateAlatLaboratoriumTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat laboratorium',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Laboratorium (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 8 kategori alat laboratorium',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('alat_laboratorium');
    }

    public function down()
    {
        $this->forge->dropTable('alat_laboratorium');
    }
}