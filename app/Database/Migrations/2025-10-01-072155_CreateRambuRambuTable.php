...
class CreateRambuRambuTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            // Field khusus untuk Rambu-Rambu (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 2 kategori rambu-rambu',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('rambu_rambu');
    }

    public function down()
    {
        $this->forge->dropTable('rambu_rambu');
    }
}