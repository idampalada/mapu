...
class CreateAlatPertanianTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            // Field khusus untuk Alat Pertanian (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 1 kategori alat pertanian',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('alat_pertanian');
    }

    public function down()
    {
        $this->forge->dropTable('alat_pertanian');
    }
}