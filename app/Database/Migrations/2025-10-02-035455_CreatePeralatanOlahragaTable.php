...
class CreatePeralatanOlahragaTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk peralatan olahraga',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Peralatan Olahraga (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 1 kategori peralatan olahraga',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('peralatan_olahraga');
    }

    public function down()
    {
        $this->forge->dropTable('peralatan_olahraga');
    }
}