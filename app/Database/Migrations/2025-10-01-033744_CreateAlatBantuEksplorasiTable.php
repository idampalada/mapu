...
class CreateAlatBantuEksplorasiTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat bantu eksplorasi',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Bantu Eksplorasi (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 2 kategori alat bantu eksplorasi',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('alat_bantu_eksplorasi');
    }

    public function down()
    {
        $this->forge->dropTable('alat_bantu_eksplorasi');
    }
}