...
class CreateJaringanTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            // Field khusus untuk Jaringan (bisa ditambahkan sesuai kebutuhan)
            'panjang_jaringan' => [
                'type'       => 'DECIMAL',
                'constraint' => '10,2',
                'null'       => true,
                'comment'    => 'Panjang jaringan (m/km)',
            ],
            'kapasitas' => [
                'type'       => 'VARCHAR',
                'constraint' => 100,
                'null'       => true,
                'comment'    => 'Kapasitas jaringan',
            ],
            'kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
        ...
        $this->forge->createTable('jaringan');
    }

    public function down()
    {
        $this->forge->dropTable('jaringan');
    }
}