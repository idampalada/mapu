...
class CreateAlatBengkelAlatUkurTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat bengkel/ukur',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Bengkel dan Ukur
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: ALAT BENGKEL BERMESIN, ALAT BENGKEL TAK BERMESIN, ALAT UKUR',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'ALAT BENGKEL DAN ALAT UKUR',
        ...
        $this->forge->createTable('alat_bengkel_alat_ukur');
    }

    public function down()
    {
        $this->forge->dropTable('alat_bengkel_alat_ukur');
    }
}