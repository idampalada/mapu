...
class CreateAlatProduksiPengolahanTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat produksi pengolahan',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Produksi Pengolahan (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 3 kategori alat produksi pengolahan',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'ALAT PRODUKSI PENGOLAHAN DAN PEMURNIAN',
        ...
        $this->forge->createTable('alat_produksi_pengolahan');
    }

    public function down()
    {
        $this->forge->dropTable('alat_produksi_pengolahan');
    }
}