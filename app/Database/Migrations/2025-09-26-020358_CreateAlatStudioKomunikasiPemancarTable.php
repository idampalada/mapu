...
class CreateAlatStudioKomunikasiPemancarTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat studio/komunikasi/pemancar',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Studio, Komunikasi dan Pemancar
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: ALAT STUDIO, ALAT KOMUNIKASI, PERALATAN PEMANCAR, PERALATAN KOMUNIKASI NAVIGASI',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'ALAT STUDIO, KOMUNIKASI DAN PEMANCAR',
        ...
        $this->forge->createTable('alat_studio_komunikasi_pemancar');
    }

    public function down()
    {
        $this->forge->dropTable('alat_studio_komunikasi_pemancar');
    }
}