...
class CreateAlatKantorRumahTanggaTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat kantor/rumah tangga',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Kantor dan Rumah Tangga
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: ALAT KANTOR, ALAT RUMAH TANGGA',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'ALAT KANTOR DAN RUMAH TANGGA',
        ...
        $this->forge->createTable('alat_kantor_rumah_tangga');
    }

    public function down()
    {
        $this->forge->dropTable('alat_kantor_rumah_tangga');
    }
}