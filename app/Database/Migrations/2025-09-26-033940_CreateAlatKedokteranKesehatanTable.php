...
class CreateAlatKedokteranKesehatanTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk alat kedokteran/kesehatan',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Alat Kedokteran dan Kesehatan
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: ALAT KEDOKTERAN, ALAT KESEHATAN UMUM',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'ALAT KEDOKTERAN DAN KESEHATAN',
        ...
        $this->forge->createTable('alat_kedokteran_kesehatan');
    }

    public function down()
    {
        $this->forge->dropTable('alat_kedokteran_kesehatan');
    }
}