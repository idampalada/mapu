...
class CreatePeralatanProfesiTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'merk' => [
                ...
                'constraint' => 255,
                'null'       => true,
                'comment'    => 'Merk peralatan profesi/produksi',
            ],
            'kuantitas' => [
                'type'       => 'INT',
                'constraint' => 11,
            ...
            // Field khusus untuk Peralatan Profesi/Produksi (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 1 kategori peralatan profesi/produksi',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
            ...
            'kategori_utama' => [
                ...
                'constraint' => 100,
                'null'       => false,
                'default'    => 'PERALATAN PROFESI/PRODUKSI',
        ...
        $this->forge->createTable('peralatan_profesi');
    }

    public function down()
    {
        $this->forge->dropTable('peralatan_profesi');
    }
}