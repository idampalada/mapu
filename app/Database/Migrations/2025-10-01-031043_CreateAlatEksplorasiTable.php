...
class CreateAlatEksplorasiTable extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            // Field khusus untuk Alat Eksplorasi (sama dengan alat elektronik lainnya)
            'processor' => [
                'type'       => 'VARCHAR',
                'constraint' => 200,
                'null'       => true,
            ...
            'kelompok' => [
                ...
                'constraint' => 200,
                'null'       => false,
                'comment'    => 'Kelompok: 2 kategori alat eksplorasi',
            ],
            'sub_kelompok' => [
                'type'       => 'VARCHAR',
                'constraint' => 150,
        ...
        $this->forge->createTable('alat_eksplorasi');
    }

    public function down()
    {
        $this->forge->dropTable('alat_eksplorasi');
    }
}