...
class MonumenModel extends Model
{
    protected $table = 'monumen';
    ...
    // Get valid kelompok untuk monumen
    ...
    public function isValidKelompokMonumen($kelompok)
    {
    ...
    {
        $mapping = [
            'CANDI' => 'Candi/Tugu Peringatan/Prasasti',
            'TUGU PERINGATAN' => 'Candi/Tugu Peringatan/Prasasti',
            'PRASASTI' => 'Candi/Tugu Peringatan/Prasasti',
            'MONUMEN' => 'Candi/Tugu Peringatan/Prasasti',
            'CANDI/TUGU PERINGATAN/PRASASTI' => 'Candi/Tugu Peringatan/Prasasti' // Tambahkan ini!
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? 'Candi/Tugu Peringatan/Prasasti';
    }
    ...
    public function searchMonumen($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori
        $cleaned['kategori_utama'] = 'GEDUNG DAN BANGUNAN - MONUMEN';
    ...
    public function getDashboardData()
    {
        ...
        $data['candi'] = $this->countByKelompok('CANDI');
        $data['tugu_peringatan'] = $this->countByKelompok('TUGU PERINGATAN');
        $data['prasasti'] = $this->countByKelompok('PRASASTI');
        $data['monumen'] = $this->countByKelompok('MONUMEN');
