...
class AlatKeselamatanKerjaModel extends Model
{
    protected $table = 'alat_keselamatan_kerja';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 4 kategori alat keselamatan kerja
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatKeselamatanKerja($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT KESELAMATAN KERJA (4 KATEGORI)
        $kelompokList = [
            'ALAT DETEKSI',
            'ALAT PELINDUNG',
            'ALAT SAR',
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT KESELAMATAN KERJA ============
    ...
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            ...
            'ALAT SAR' => 'Alat SAR',
            'ALAT KERJA PENERBANGAN' => 'Alat Kerja Penerbangan'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat keselamatan kerja
    public function isValidKelompokAlatKeselamatanKerja($kelompok)
    {
        $validKelompok = [
            'ALAT DETEKSI',
            'ALAT PELINDUNG',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatKeselamatanKerja($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat keselamatan kerja yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatKeselamatanKerja($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT KESELAMATAN KERJA
        $cleaned['kategori_utama'] = 'ALAT KESELAMATAN KERJA';
