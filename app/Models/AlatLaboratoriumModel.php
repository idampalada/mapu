...
class AlatLaboratoriumModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 8 kategori alat laboratorium
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatLaboratorium($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT LABORATORIUM (8 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT LABORATORIUM ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'UNIT ALAT LABORATORIUM' => 'Unit Alat Laboratorium',
            'UNIT ALAT LABORATORIUM KIMIA PELAJAR' => 'Unit Alat Laboratorium Kimia Pelajar',
            'ALAT LABORATORIUM FISIKA NUKLIR/ELEKTRONIKA' => 'Alat Laboratorium Fisika Nuklir/Elektronika',
            'ALAT PROTEKSI RADIASI/PROTEKSI LINGKUNGAN' => 'Alat Proteksi Radiasi/Proteksi Lingkungan',
            'RADIATION APPLICATION & NON DESTRUCTIVE TESTING LABORATORY' => 'Radiation Application & Non Destructive Testing Laboratory',
            'ALAT LABORATORIUM LINGKUNGAN HIDUP' => 'Alat Laboratorium Lingkungan Hidup',
            'PERALATAN LABORATORIUM HYDRODINAMICA' => 'Peralatan Laboratorium Hydrodinamica',
            'ALAT LABORATORIUM STANDARISASI KALIBRASI & INSTRUMENTASI' => 'Alat Laboratorium Standarisasi Kalibrasi & Instrumentasi'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat laboratorium
    public function isValidKelompokAlatLaboratorium($kelompok)
    {
        $validKelompok = [
            'UNIT ALAT LABORATORIUM',
            'UNIT ALAT LABORATORIUM KIMIA PELAJAR',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatLaboratorium($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat laboratorium yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatLaboratorium($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT LABORATORIUM
        $cleaned['kategori_utama'] = 'ALAT LABORATORIUM';
