...
class PeralatanOlahragaModel extends Model
{
    protected $table = 'peralatan_olahraga';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 1 kategori peralatan olahraga
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchPeralatanOlahraga($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
{
    ...
    // Per kelompok - KHUSUS UNTUK PERALATAN OLAHRAGA (1 KATEGORI)
    $kelompokList = [
        'PERALATAN OLAH RAGA'  // Perbaiki spasi
    ];
    ...
    // ============ BUSINESS LOGIC KHUSUS PERALATAN OLAHRAGA ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
{
    $mapping = [
        'PERALATAN OLAH RAGA' => 'Peralatan Olah Raga'  // Perbaiki spasi
    ];
    
    return $mapping[strtoupper($kelompok_api)] ?? null;
}

    // 17. Cek apakah kelompok valid untuk peralatan olahraga
    public function isValidKelompokPeralatanOlahraga($kelompok)
{
    $validKelompok = [
        'PERALATAN OLAH RAGA'  // Perbaiki spasi
    ];
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokPeralatanOlahraga($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok peralatan olahraga yang valid';
        }
    ...
    {
        return $this->isValidKelompokPeralatanOlahraga($kelompok);
    }
...
// Set kategori - KHUSUS UNTUK PERALATAN OLAHRAGA
$cleaned['kategori_utama'] = 'PERALATAN OLAH RAGA';  // Perbaiki spasi
