...
class AlatPertanianModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 1 kategori alat pertanian
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatPertanian($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT PERTANIAN (1 KATEGORI)
        $kelompokList = [
            'ALAT PENGOLAHAN'
        ];
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT PERTANIAN ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT PENGOLAHAN' => 'Alat Pengolahan'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat pertanian
    public function isValidKelompokAlatPertanian($kelompok)
    {
        $validKelompok = [
            'ALAT PENGOLAHAN'
        ];
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatPertanian($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat pertanian yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatPertanian($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT PERTANIAN
        $cleaned['kategori_utama'] = 'ALAT PERTANIAN';
