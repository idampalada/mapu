...
class AlatBengkelAlatUkurModel extends Model
{
    protected $table = 'alat_bengkel_alat_ukur';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // ALAT BENGKEL BERMESIN, ALAT BENGKEL TAK BERMESIN, ALAT UKUR
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatBengkelAlatUkur($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT BENGKEL DAN UKUR ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT BENGKEL BERMESIN' => 'Alat Bengkel Bermesin',
            'ALAT BENGKEL TAK BERMESIN' => 'Alat Bengkel Tak Bermesin',
            'ALAT UKUR' => 'Alat Ukur'
        ];
    ...
    // 17. Cek apakah kelompok valid untuk alat bengkel dan ukur
    public function isValidKelompokAlatBengkelAlatUkur($kelompok)
    {
        $validKelompok = [
            'ALAT BENGKEL BERMESIN',
            'ALAT BENGKEL TAK BERMESIN',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatBengkelAlatUkur($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat bengkel dan ukur yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatBengkelAlatUkur($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori
        $cleaned['kategori_utama'] = 'ALAT BENGKEL DAN ALAT UKUR';
