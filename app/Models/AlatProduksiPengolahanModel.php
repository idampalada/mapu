...
class AlatProduksiPengolahanModel extends Model
{
    protected $table = 'alat_produksi_pengolahan';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 3 kategori alat produksi pengolahan
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatProduksiPengolahan($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT PRODUKSI PENGOLAHAN (3 KATEGORI)
        $kelompokList = [
            'SUMUR',
            'PRODUKSI',
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT PRODUKSI PENGOLAHAN ============
    ...
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'SUMUR' => 'Sumur',
            'PRODUKSI' => 'Produksi',
            'PENGOLAHAN DAN PEMURNIAN' => 'Pengolahan dan Pemurnian'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat produksi pengolahan
    public function isValidKelompokAlatProduksiPengolahan($kelompok)
    {
        $validKelompok = [
            'SUMUR',
            'PRODUKSI',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatProduksiPengolahan($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat produksi pengolahan yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatProduksiPengolahan($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT PRODUKSI PENGOLAHAN
        $cleaned['kategori_utama'] = 'ALAT PRODUKSI PENGOLAHAN DAN PEMURNIAN';
