...
class AlatKantorRumahTanggaModel extends Model
{
    protected $table = 'alat_kantor_rumah_tangga';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // ALAT KANTOR, ALAT RUMAH TANGGA
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatKantorRumahTangga($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT KANTOR DAN RUMAH TANGGA
        $kelompokList = [
            'ALAT KANTOR',
            'ALAT RUMAH TANGGA'
        ];
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT KANTOR DAN RUMAH TANGGA ============
    ...
    // 17. Cek apakah kelompok valid untuk alat kantor dan rumah tangga
    public function isValidKelompokAlatKantorRumahTangga($kelompok)
    {
        $validKelompok = [
            'ALAT KANTOR',
            'ALAT RUMAH TANGGA'
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatKantorRumahTangga($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat kantor dan rumah tangga yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatKantorRumahTangga($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT KANTOR DAN RUMAH TANGGA
        $cleaned['kategori_utama'] = 'ALAT KANTOR DAN RUMAH TANGGA';
