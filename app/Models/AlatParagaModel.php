...
class AlatParagaModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 1 kategori alat peraga
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatPeraga($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT PERAGA (1 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT PERAGA ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT PERAGA PELATIHAN DAN PERCONTOHAN' => 'Alat Peraga Pelatihan dan Percontohan'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat peraga
    public function isValidKelompokAlatPeraga($kelompok)
    {
        $validKelompok = [
            'ALAT PERAGA PELATIHAN DAN PERCONTOHAN'
        ];
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatPeraga($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat peraga yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatPeraga($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT PERAGA
        $cleaned['kategori_utama'] = 'ALAT PERAGA';
