...
class AlatEksplorasiModel extends Model
{
    protected $table = 'alat_eksplorasi';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 2 kategori alat eksplorasi
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatEksplorasi($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT EKSPLORASI (2 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT EKSPLORASI ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT EKSPLORASI TOPOGRAFI' => 'Alat Eksplorasi Topografi',
            'ALAT EKSPLORASI GEOFISIKA' => 'Alat Eksplorasi Geofisika'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat eksplorasi
    public function isValidKelompokAlatEksplorasi($kelompok)
    {
        $validKelompok = [
            'ALAT EKSPLORASI TOPOGRAFI',
            'ALAT EKSPLORASI GEOFISIKA'
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatEksplorasi($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat eksplorasi yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatEksplorasi($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT EKSPLORASI
        $cleaned['kategori_utama'] = 'ALAT EKSPLORASI';
