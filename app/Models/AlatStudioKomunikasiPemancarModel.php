...
class AlatStudioKomunikasiPemancarModel extends Model
{
    protected $table = 'alat_studio_komunikasi_pemancar';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // ALAT STUDIO, ALAT KOMUNIKASI, PERALATAN PEMANCAR, PERALATAN KOMUNIKASI NAVIGASI
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatStudioKomunikasiPemancar($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT STUDIO, KOMUNIKASI DAN PEMANCAR
        $kelompokList = [
            'ALAT STUDIO',
            'ALAT KOMUNIKASI',
            'PERALATAN PEMANCAR',
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT STUDIO, KOMUNIKASI DAN PEMANCAR ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT STUDIO' => 'Alat Studio',
            'ALAT KOMUNIKASI' => 'Alat Komunikasi',
            'PERALATAN PEMANCAR' => 'Peralatan Pemancar',
            'PERALATAN KOMUNIKASI NAVIGASI' => 'Peralatan Komunikasi Navigasi'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat studio komunikasi pemancar
    public function isValidKelompokAlatStudioKomunikasiPemancar($kelompok)
    {
        $validKelompok = [
            'ALAT STUDIO',
            'ALAT KOMUNIKASI',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatStudioKomunikasiPemancar($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat studio, komunikasi dan pemancar yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatStudioKomunikasiPemancar($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT STUDIO, KOMUNIKASI DAN PEMANCAR
        $cleaned['kategori_utama'] = 'ALAT STUDIO, KOMUNIKASI DAN PEMANCAR';
    ...
    // 25. Helper method - Safe date conversion (TAMBAHAN BARU)
