...
class AlatBantuEksplorasiModel extends Model
{
    protected $table = 'alat_bantu_eksplorasi';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 2 kategori alat bantu eksplorasi
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatBantuEksplorasi($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT BANTU EKSPLORASI (2 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT BANTU EKSPLORASI ============
    ...
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            ...
            'ALAT BANTU PRODUKSI' => 'Alat Bantu Produksi'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat bantu eksplorasi
    public function isValidKelompokAlatBantuEksplorasi($kelompok)
    {
        $validKelompok = [
            'ALAT BANTU EKSPLORASI',
            'ALAT BANTU PRODUKSI'
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatBantuEksplorasi($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat bantu eksplorasi yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatBantuEksplorasi($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT BANTU EKSPLORASI
        $cleaned['kategori_utama'] = 'ALAT BANTU EKSPLORASI';
