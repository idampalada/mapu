...
class RambuRambuModel extends Model
{
    protected $table = 'rambu_rambu';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 2 kategori rambu-rambu
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchRambuRambu($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK RAMBU-RAMBU (2 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS RAMBU-RAMBU ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'RAMBU-RAMBU LALU LINTAS DARAT' => 'Rambu-Rambu Lalu Lintas Darat',
            'RAMBU-RAMBU LALU LINTAS UDARA' => 'Rambu-Rambu Lalu Lintas Udara'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk rambu-rambu
    public function isValidKelompokRambuRambu($kelompok)
    {
        $validKelompok = [
            'RAMBU-RAMBU LALU LINTAS DARAT',
            'RAMBU-RAMBU LALU LINTAS UDARA'
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokRambuRambu($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok rambu-rambu yang valid';
        }
    ...
    {
        return $this->isValidKelompokRambuRambu($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK RAMBU-RAMBU
        $cleaned['kategori_utama'] = 'RAMBU-RAMBU';
