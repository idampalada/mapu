...
class AlatPengeboranModel extends Model
{
    protected $table = 'alat_pengeboran';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 2 kategori alat pengeboran
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatPengeboran($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT PENGEBORAN (2 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT PENGEBORAN ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'ALAT PENGEBORAN MESIN' => 'Alat Pengeboran Mesin',
            'ALAT PENGEBORAN NON MESIN' => 'Alat Pengeboran Non Mesin'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat pengeboran
    public function isValidKelompokAlatPengeboran($kelompok)
    {
        $validKelompok = [
            'ALAT PENGEBORAN MESIN',
            'ALAT PENGEBORAN NON MESIN'
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatPengeboran($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat pengeboran yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatPengeboran($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT PENGEBORAN
        $cleaned['kategori_utama'] = 'ALAT PENGEBORAN';
