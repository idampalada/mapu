...
class BangunanAirModel extends Model
{
    ...
    protected $allowedFields = [
        ...
        'luas_dasar',
        'luas_bangunan',
        'kelompok', // BANGUNAN AIR IRIGASI, BANGUNAN PENGAIRAN PASANG SURUT, dll
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    protected $validationRules = [
        ...
        'luas_dasar' => 'permit_empty|decimal',
        'luas_bangunan' => 'permit_empty|decimal',
    ...
    protected $validationMessages = [
        ...
        'luas_dasar' => [
            'decimal' => 'Luas dasar harus berupa angka'
        ],
        'luas_bangunan' => [
            'decimal' => 'Luas bangunan harus berupa angka'
        ],
        'nilai_perolehan' => [
    ...
    public function searchBangunanAir($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    // ============ BUSINESS LOGIC KHUSUS BANGUNAN AIR ============
    ...
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            ...
            'BANGUNAN PENGAIRAN PASANG SURUT' => 'Bangunan Pengairan Pasang Surut', 
            'BANGUNAN PENGEMBANGAN RAWA DAN POLDER' => 'Bangunan Pengembangan Rawa dan Polder',
            'BANGUNAN PENGAMAN SUNGAI/PANTAI & PENANGGULAN BENCANA ALAM' => 'Bangunan Pengaman Sungai/Pantai & Penanggulan Bencana Alam',
            'BANGUNAN PENGEMBANGAN SUMBER AIR DAN AIR TANAH' => 'Bangunan Pengembangan Sumber Air dan Air Tanah',
            'BANGUNAN AIR BERSIH/AIR BAKU' => 'Bangunan Air Bersih/Air Baku',
            'BANGUNAN AIR KOTOR' => 'Bangunan Air Kotor'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk bangunan air
    public function isValidKelompokBangunanAir($kelompok)
    {
        $validKelompok = [
            'BANGUNAN AIR IRIGASI',
            'BANGUNAN PENGAIRAN PASANG SURUT',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokBangunanAir($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok bangunan air yang valid';
        }
        ...
        // Numeric validation
        $numericFields = ['kuantitas', 'nilai_perolehan', 'nilai_penyusutan', 'nilai_buku', 'luas_dasar', 'luas_bangunan'];
    ...
    {
        return $this->isValidKelompokBangunanAir($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        $cleaned['luas_dasar'] = $this->safeFloat($data['luas_dasar'] ?? 0);
        ...
        // Set kategori
        $cleaned['kategori_utama'] = 'BANGUNAN AIR';
