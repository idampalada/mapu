...
class AlatPersenjataanModel extends Model
{
    protected $table = 'alat_persenjataan';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 9 kategori alat persenjataan
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchAlatPersenjataan($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK ALAT PERSENJATAAN (4 KATEGORI)
        $kelompokList = [
            'SENJATA API',
    ...
    // ============ BUSINESS LOGIC KHUSUS ALAT PERSENJATAAN ============
    ...
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            ...
            'PERSENJATAAN NON SENJATA API' => 'Persenjataan Non Senjata Api',
            'SENJATA SINAR' => 'Senjata Sinar',
            'ALAT KHUSUS KEPOLISIAN' => 'Alat Khusus Kepolisian'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk alat persenjataan
    public function isValidKelompokAlatPersenjataan($kelompok)
    {
        $validKelompok = [
            'SENJATA API',
            'PERSENJATAAN NON SENJATA API',
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokAlatPersenjataan($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok alat persenjataan yang valid';
        }
    ...
    {
        return $this->isValidKelompokAlatPersenjataan($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK ALAT PERSENJATAAN
        $cleaned['kategori_utama'] = 'ALAT PERSENJATAAN';
