...
class PeralatanProfesiModel extends Model
{
    protected $table = 'peralatan_profesi';
    ...
    protected $allowedFields = [
        ...
        'monitor',
        'spek_lain',
        'kelompok', // 1 kategori peralatan profesi/produksi
        'sub_kelompok',
        'kategori_utama',
        'kategori_detail',
        'created_at',
    ...
    public function searchPeralatanProfesi($searchTerm = '', $kelompok = '', $limit = 100, $offset = 0)
    {
        $builder = $this->builder();
    ...
    public function getDashboardData()
    {
        ...
        // Per kelompok - KHUSUS UNTUK PERALATAN PROFESI/PRODUKSI (1 KATEGORI)
        $kelompokList = [
    ...
    // ============ BUSINESS LOGIC KHUSUS PERALATAN PROFESI/PRODUKSI ============
    
    // 16. Mapping kelompok dari API ke kategori detail
    public function mapKelompokToKategori($kelompok_api) 
    {
        $mapping = [
            'UNIT PERALATAN PROSES/PRODUKSI' => 'Unit Peralatan Proses/Produksi'
        ];
        
        return $mapping[strtoupper($kelompok_api)] ?? null;
    }

    // 17. Cek apakah kelompok valid untuk peralatan profesi/produksi
    public function isValidKelompokPeralatanProfesi($kelompok)
    {
        $validKelompok = [
            'UNIT PERALATAN PROSES/PRODUKSI'
        ];
    ...
    public function validateImportData($data)
    {
        ...
        if (isset($data['kelompok']) && !$this->isValidKelompokPeralatanProfesi($data['kelompok'])) {
            $errors[] = 'Kelompok harus salah satu dari kelompok peralatan profesi/produksi yang valid';
        }
    ...
    {
        return $this->isValidKelompokPeralatanProfesi($kelompok);
    }
    ...
    public function cleanImportData($data)
    {
        ...
        // Set kategori - KHUSUS UNTUK PERALATAN PROFESI/PRODUKSI
        $cleaned['kategori_utama'] = 'PERALATAN PROFESI/PRODUKSI';
