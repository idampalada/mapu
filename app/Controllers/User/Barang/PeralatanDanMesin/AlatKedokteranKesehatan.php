...
class AlatKedokteranKesehatan extends BaseController
{
    ...
    public function dashboard()
    {
        ...
        return view('user/barang/peralatandanmesin/alatkedokterankesehatan/dashboardalatkkedokterankesehatan', [
    ...
    public function kelompokAlatKedokteranKesehatan()
    {
        ...
        return view('user/barang/peralatandanmesin/alatkkedokterankesehatan/kelompokalatkkedokterankesehatan', [
            'sort' => $sort,
            'order' => $order,
            'allData' => $allData,
        ]);
    ...
    public function kelompokDetail($kelompok)
    {
        ...
        if (!$this->alatKedokteranKesehatanModel->isValidKelompokAlatKedokteranKesehatan($kelompok)) {
            ...
            return redirect()->to('user/barang/peralatandanmesin/alatkkedokterankesehatan/kelompokalatkkedokterankesehatan');
        }
        ...
        $pager = service('pager');
        $pager->setPath('user/barang/peralatandanmesin/alatkkedokterankesehatan/kelompokalatkkedokterankesehatan/' . 
                        urlencode($kelompok));
